...
public:     //constructors
    ...
    explicit Location(const int32_t i, deque<int32_t>::size_type p_historyLength=10): ID(i), Currentvisits(0), HistoryLength(p_historyLength), CurrentRiskScore(0) {};
...
private:
    ...
    deque<int32_t>::size_type HistoryLength; //length of the visitor history that should be tracked per location
